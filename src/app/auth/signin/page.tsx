...
export default function SignIn() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (isLogin) {
      ...
      // Handle registration using our custom auth hook
      ...
      try {
        ...
        if (success) {
          ...
          if (loginSuccess) {
            ...
            setLoading(false);
            // Optional: Reset form and switch to login view
            setIsLogin(true);
          }
        } else {
  ...
  const handleSocialLogin = (provider: string) => {
    console.log(`Social login with ${provider} is not implemented in this version.`);
    setError(`Social login with ${provider} is not available in this version.`);
    // Note: Social login would require additional implementation with the custom auth system
  };
